...
export default function AboutPage() {
  return (
    <Container className="flex flex-col gap-12 py-16 sm:py-20">
      ...
      <div className="flex items-center gap-4 rounded-card border border-certified-border bg-certified-surface-2 p-6 dark:border-white/10 dark:bg-white/[0.04] dark:backdrop-blur-xl">
      ...
      <div className="flex flex-col items-start gap-4 rounded-card border border-dashed border-certified-gold/40 bg-certified-surface-2 p-8 dark:bg-white/[0.04] dark:backdrop-blur-xl">
        <p className="font-display text-xl text-certified-navy">
          Know a training business that deserves to be found?
        </p>
...
function Pillar({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <li className="rounded-card border border-certified-border bg-certified-surface p-5 dark:bg-white/[0.04] dark:backdrop-blur-xl">
