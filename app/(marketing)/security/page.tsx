...
export default function SecurityPage() {
  return (
    <Container className="flex flex-col gap-16 py-16 sm:py-20">
      ...
      <div className="flex flex-col items-center gap-4 rounded-card border border-certified-border bg-certified-surface-2 p-8 text-center">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <Card>
            ...
            <p className="mt-2 text-sm text-certified-muted">
              ...
              leaves the server and is never returned in any API response. Every verification re-checks it — a
              direct database edit that bypasses the signing service breaks the signature.
            </p>
          </Card>
          <Card>
            <p className="font-semibold text-certified-navy">Rate-limited lookups</p>
            <p className="mt-2 text-sm text-certified-muted">
              The verification endpoint is public by design — it has to be frictionless — but it's rate-limited per
              IP, with no bulk-listing capability anywhere in the system.
            </p>
          </Card>
          <Card>
